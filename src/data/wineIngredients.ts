...
export const wineIngredientCategories: IngredientCategory[] = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: 'sulfites', name: 'Sulfites', isAllergen: true, note: '"Sulfites" can be used as a generic term for all sulfur compounds. You can declare them individually (e.g., sulfur dioxide) or collectively as "Sulfites".' },
      { id: 'sulfur_dioxide', name: 'Sulfur dioxide', isAllergen: true },
      { id: 'potassium_bisulfite', name: 'Potassium bisulfite', isAllergen: true },
      { id: 'potassium_metabisulfite', name: 'Potassium metabisulfite', isAllergen: true },
    ],
  },
  {
    id: 'processing_aids',
